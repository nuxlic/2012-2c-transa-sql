    ...
    public partial class RegistroUsuarioForm : Form
    {
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            else if (this.txtPassword.Text == this.txtConfirmarPassword.Text)
            {
                ...
                {
                    int roleId;
                    if ((this.cmbTipoUsr.SelectedItem as string) == "Cliente") roleId = 2;
                    else roleId = 3;
                    ...
                    sentece2.AppendFormat("SELECT TOP 1 CU.UserId FROM TRANSA_SQL.CuponeteUser CU ORDER BY CU.UserId DESC", this.txtUsername.Text, password, roleId);
